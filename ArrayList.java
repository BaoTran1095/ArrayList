 ...
 * 	 1.2	 3/2/2015	 added required methods
 * Class Description
 * -----------------
 ...
 * 
 * remove(Integer)		 find and remove the Integer, return true false upon the result
 * remove(String)		 find and remove the String, return true false upon the result
 * removeAll(ArrayList)	 remove all the common elements, and return true or false upon result
 * lastIndexOf(int)		 return the index of the last occurence of the given int
 * retainAll(ArrayList)	 return an array list of common elements
 * containAll(ArrayList) return true if list has all element from the otehr list
...
public class ArrayList<E>
{
	...
	public boolean remove(Object object){//Integer elementValue
		
		int index = indexOf((E)object);
...
//		
//	}
	public boolean removeAll(ArrayList list){
		int sizeCheck = size;
	...
	public boolean retainAll(ArrayList list){
